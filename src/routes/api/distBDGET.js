...
class PackGET extends Route {
	...
	run(req, res) {
		const content = oneLine`var magane = function () {};
		...
		magane.prototype.getName = function () { return 'Bringing LINE stickers to Discord in a chaotic way.'; };
		magane.prototype.getDescription = function () { return 'Magane'; };
		magane.prototype.getVersion = function () { return '0.1.0'; };
